    ...
    <div className="h-screen w-full flex flex-col">
      ...
      <div className="flex-grow w-full relative flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-lg px-6">
          <div className="bg-white bg-opacity-95 backdrop-blur-sm rounded-md shadow-2xl p-8 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {error && (
                <p className="text-red-800 text-sm text-center bg-red-50 p-2 rounded-md">
                  {error}
                </p>
              )}
